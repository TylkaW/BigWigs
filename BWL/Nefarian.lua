...
L:RegisterTranslations("frFR", function() return {
	...
	triggershamans	= "Chamans",
	triggerdruid	= "druides",
	triggerwarlock	= "démonistes",
	triggerpriest	= "Prêtres",
	triggerhunter	= "chasseurs",
	triggerwarrior	= "Guerriers",
...
function BigWigsNefarian:BigWigs_RecvSync( sync )
	...
	elseif sync == "NefarianFear" and self.db.profile.fear then
		...
		self:ScheduleEvent("bwneffearsoon", "BigWigs_Message", 20, L["fear_soon_warning"], "Important")
